export interface Channel {
  ...
  emailGroup?: number // Added to link with email groups
  enableFiltering?: boolean
  filterWindowSize?: number
}

// Add this line after the Channel interface definition to export Channel as ChannelConfig
...
export const channels: Channel[] = [
 ...
 // { id: 2791703, name: "MI_SRT3", enableFlowCalculation: false, emailGroup: 1 },
  { id: 2792378, name: "FIT Sfax Nord", enableFlowCalculation: false, emailGroup: 1 },
...
{ id: 2796008, name: "KER_SPE1 ", surface: 7.1, enableFlowCalculation: true, emailGroup: 2 },
 { id: 2785177, name: "Pression refoulement Saline", enableFlowCalculation: false, emailGroup: 1 },
